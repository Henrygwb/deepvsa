...
class count_categories(object):
    ...
    def load_data(self, trace_folder):
        ...
        if self.model_option == 0 or self.model_option == 1 or self.model_option == 2 or self.model_option == 3:
            check_file = os.path.join(check_path, 'test_seq.npz')
        else:
            check_file = os.path.join(check_path, 'test_seq_inst.npz')
...
if __name__ == "__main__":
    ...
    trace_folder = '/home/wzg13/work/deepvsa/Traces/vulnerable'  
    seq_len = 400
    label_train = [0,1,2,3]
    model_option = 4
    print trace_folder
