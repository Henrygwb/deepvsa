...
class DEEPVSA(object):
    ...
    def fit(self, batch_size, epoch_1, epoch_2, save_model, save_dir, truncate):
        ...
        if self.train_label == 3 or self.train_label == 2:
            self.model.compile(optimizer=Adam(lr=0.001), loss='categorical_crossentropy', metrics=['accuracy'], sample_weight_mode="temporal")
...
if __name__ == "__main__":
    ...
    fine_traces_path = "../../original_data/finetune_traces"
    test_traces_path = ' '
    ...
    for train_label in label_train:
        ...
        inst, label, inst_len = load_data(fine_traces_path, model_option=model_option, npz_path=npz_path_train,
        ...
        inst_test = inst_test[0:10000]
        label_test = label_test[0:10000]
