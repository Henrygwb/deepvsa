...
vs_handler_func vs_handler[] = {
	...
	&push_vs_handler, //20
	&pop_vs_handler, //21
	&pushregs_vs_handler, //22
	&popregs_vs_handler, //23
	&pushflags_vs_handler, //24
	&popflags_vs_handler, //25
	&enter_vs_handler, //26
	&leave_vs_handler, //27
        /* insn_comparison */
	&test_vs_handler, //28
	...
	&movcc_vs_handler, //31
	&xchg_vs_handler, //32
	&xchgcc_vs_handler, //33
        /* insn_string */ 
	&strcmp_vs_handler, //34 
	&strload_vs_handler, //35
	&strmov_vs_handler, //36
	&strstore_vs_handler, //37
	&translate_vs_handler, //38 
        /* insn_bit_manip */
	&bittest_vs_handler, //39
	&bitset_vs_handler, //40
	&bitclear_vs_handler, //41
	/* insn_system */
	//&halt_vs_handler,
        /* insn_other */
	&nop_vs_handler, //42
	&szconv_vs_handler, //43
	&unknown_vs_handler, //44
	&clear_dir_vs_handler, //45
	&sys_vs_handler, //46
	&int_vs_handler, //47
	&in_vs_handler, //48
	&out_vs_handler, //49
